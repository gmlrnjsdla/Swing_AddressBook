...
public class WinUpdateMember extends JDialog {
	...
	public WinUpdateMember(String jumin) {
		...
		JButton btnInsertMember = new JButton("\uC218\uC815 \uC644\uB8CC");
	...
	protected void UpdateMember() {
		try {
			...
			String sql = "UPDATE addresstbl SET name='"+tfName.getText()+"', mobile='"+tfMobile.getText()+"', "
					+"address='"+tfAddress.getText()+"', company='"+tfCompany.getText()+"', pic='"+picPath.replaceAll("\\\\", "/")+"' "
							+ "WHERE jumin='"+tfJumin1.getText()+tfJumin2.getText()+"'";
